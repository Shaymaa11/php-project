        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        <div class="col-lg-12 col-md-12"><br><br>
                            <h2 style="color: rgb(131, 80, 4);">Your <br />SEARCH HERE</h2>
                            <p></p>
                        </div>
                ...
                <div class="col-lg-9">
                    ...
                    if ($sel == "all") {
                        $select_query = "select * from products where name like '%$key%'";
                        $stmt = $db->prepare($select_query);
                        $resobj = $stmt->execute([]);
                        if ($stmt->rowCount() > 0) {
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            ";
                            ...
                            echo "<img  src='download.jpg' width=250px height=250px>";
                        }
                    } else {

                        $select_queryname = "select * from categories where name=? ";
                        $stm = $db->prepare($select_queryname);
                        $cat = @$_REQUEST["selct"];
                        ...
                        //var_dump($catid);
                        $select_query = "select * from products where name like '%$key%'and category_id=?";
                        $stmts = $db->prepare($select_query);
                        $resobj = $stmts->execute([@$catid]);
